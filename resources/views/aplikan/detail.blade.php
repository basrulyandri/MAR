        ...
        <div class="row">
            <div class="col-lg-3">
               <div class="ibox-content text-center">
                ...
                <ul class="list-group">
                    <li class="list-group-item">Jenis Kelamin <span class="pull-right">{{$aplikan->jenisKelamin()}}</span></li>
                    <li class="list-group-item">TTL <span class="pull-right">{{$aplikan->tempat_lahir}}, {{$aplikan->tanggal_lahir}}</span></li>

                    @if(auth()->user()->isAdmin() || $aplikan->isMine(auth()->user()->id))
                        ...
                        <li class="list-group-item">Alamat <span class="pull-right">{{$aplikan->alamat}}</span></li>
                    @endif
                </ul>                
                                            ...
                                            <div class="feed-activity-list">
                                                ...
                                                <div class="feed-element">
                                                    ...
                                                    <div class="media-body ">
                                                        ...
                                                        <strong class="text-success">{{$aplikan->nama}}</strong> di {{$history->pivot->type}} oleh <a href="#"><strong class="text-success">{{($history->id == auth()->user()->id) ? 'Anda' : $history->first_name}}</strong></a> . <br>
