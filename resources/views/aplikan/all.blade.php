                        ...
                        <div class="row">
                            ...
                            <form>
                                <div class="input-group">
                                    <input type="text" name="nama" placeholder="Cari Aplikan" value="{{$request->nama or ''}}" class="input-sm form-control">
                            ...
                            <div class="feed-activity-list">
                                ...
                                <div class="feed-element">
                                    ...
                                    <div class="media-body ">
                                        ...
                                        <strong><a href="{{route('aplikan.detail',$apl)}}">{{$apl->nama}}</a></strong>  </strong> sumber informasi dari <strong>{{$apl->sumberInformasi()}}</strong>                                      
                                        @if($apl->hasBeenTaken()) 
                                        , di take oleh <strong><a href="{{route('user.profile',$apl->takenBy->username)}}">{{$apl->takenBy->first_name}}</a></strong>. 
                                        @endif
                                        <br>
