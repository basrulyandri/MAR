                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content form-horizontal">                          
                          ...
                          <div class="form-group{{$errors->has('sumber_informasi') ? ' has-error' : ''}}">
                            ...
                            <div class="col-sm-10">
                                {!!Form::select('sumber_informasi',['' => 'Pilih sumber informasi',auth()->user()->id => 'Dari Saya sendiri ('.auth()->user()->username.')','brosur' => 'Brosur','presentasi' => 'Presentasi','facebook' => 'Facebook','website' => 'Website','teman' => 'Teman','lainnya' => 'Lainnya'],old('sumber_informasi'),['class' => 'form-control input-text','id' => 'sumber_informasi','required' => true])!!}
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div class="alert alert-warning">
                          ...
                          <br>file yang dimport berupa CSV. Minimal data yang harus ada adalah <b>Nama, Jenis Kelamin, email dan telpon.</b>
                        </div>

                        <a class="btn btn-sm btn-primary" target="_blank" href="{{url('import-aplikan-example.csv')}}">Download Contoh File CSV</a>
                        <a class="btn btn-sm btn-danger" target="_blank" href="{{url('PANDUAN-PENGISIAN-FILE-CSV-UNTUK-IMPORT-DATA-APLIKAN.pdf')}}">Panduan file Import</a>
                      </div>
...
$(document).ready(function(){
  ...
  $('#sumber_informasi').change(function(){
      if($(this).val() == 'lainnya'){
        $('#sumberInformasiLainnya').html('<div class="col-sm-10 col-sm-offset-2"><input type="text" class="form-control input-text" name="sumber_informasi_lainnya" placeholder="Tulisakan sumber informasi lainnya"></div>');
      }else{
