            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="">
                    ...
                    <ul class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;">
                        ...
                        <li>
                            <a href="{{route('aplikan.referensi.saya')}}"><span class="nav-label">Referensi saya</span></a>
                        </li>
                        @endif
                ...
                <li>
                    <a href="{{route('tagihan.index')}}"><i class="fa fa-money"></i> <span class="nav-label">Tagihan</span>
                    @if(jmlTagihan('tertagih') != 0)
                        <span class="label label-warning pull-right">{{jmlTagihan('tertagih')}}</span>
                    @endif
                    </a>
                </li>  
                @endif
